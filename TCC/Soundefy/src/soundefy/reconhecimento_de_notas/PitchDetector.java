...
public class PitchDetector implements Runnable {
	...
	public static final Nota[] notas = { new Nota("C1", 30.88, 34.65, 32.70),
			...
			new Nota("C6", 987.77, 1108.73, 1046.50),
			new Nota("C#6", 1046.50, 1174.66, 1108.73),
			new Nota("D6", 1108.73, 1244.51, 1174.66),
			new Nota("D#6", 1174.66, 1318.51, 1244.51),
			new Nota("E6", 1244.51, 1396.91, 1318.51),
			new Nota("F6", 1318.51, 1479.98, 1396.91),
			new Nota("F#6", 1396.91, 1567.98, 1479.98),
			new Nota("G6", 1479.98, 1661.22, 1567.98),
			new Nota("G#6", 1567.98, 1760.00, 1661.22),
			new Nota("A6", 1661.22, 1864.66, 1760.00),
			new Nota("A#6", 1760.00, 1975.53, 1864.66),
			new Nota("B6", 1864.66, 2093.00, 1975.53),
			new Nota("C7", 1975.53, 2217.46, 2093.00),
			new Nota("C#7", 2093.00, 2349.32, 2217.46),
			new Nota("D7", 2217.46, 2489.02, 2349.32),
			new Nota("D#7", 2349.32, 2637.02, 2489.02),
			new Nota("E7", 2489.02, 2793.83, 2637.02),
			new Nota("F7", 2637.02, 2959.96, 2793.83),
			new Nota("F#7", 2793.83, 3135.96, 2959.96),
			new Nota("G7", 2959.96, 3322.44, 3135.96),
			new Nota("G#7", 3135.96, 3520.00, 3322.44),
			new Nota("A7", 3322.44, 3729.31, 3520.00),
			new Nota("A#7", 3520.00, 3951.07, 3729.31),
			new Nota("B7", 3729.31, 4186.01, 3951.07), };

	private final static int RATE = 8000;
	private final static int CHANNEL_MODE = 2;
